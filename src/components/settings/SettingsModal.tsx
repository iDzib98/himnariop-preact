...
export function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
  const { color, fontSizeValue, fontFamily, theme, updateColor, updateFontSize, updateFontFamily, updateTheme } = useSettings();
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Ajustes" className={isLargeFont ? styles.largeFont : ''}>
      ...
      <div class={styles.footer}>
        <Button variant="filled" color={tempColor} onClick={onClose}>
          Cerrar
        </Button>
      </div>
    </Modal>
